...
public class NetClientHandler extends NetHandler
{
    ...
    throws IOException
  {
    ...
    par2IntegratedServer.func_71343_a().func_71754_a(
      (MemoryConnection) this.netManager, par1Minecraft.session.username);
  }
  ...
  public void handleServerAuthData(Packet253ServerAuthData par1Packet253ServerAuthData)
  {
    ...
    if (!"-".equals(var2))
    {
      ...
      String var6 = this.func_72550_a(this.mc.session.username,
    ...
    try
    {
      URL var4 = new URL(
        "http://session.minecraft.net/game/joinserver.jsp?user="
          + func_72549_a(par1Str) + "&sessionId=" + func_72549_a(par2Str)
          + "&serverId=" + func_72549_a(par3Str));
  ...
  private static String func_72549_a(String par0Str)
    throws IOException
  {
  ...
  public void handleLogin(Packet1Login par1Packet1Login)
  {
    ...
    this.worldClient = new WorldClient(this, new WorldSettings(0L,
      par1Packet1Login.gameType, false, par1Packet1Login.field_73560_c,
    ...
    this.addToSendQueue(new Packet204ClientInfo(this.mc.gameSettings.language,
      this.mc.gameSettings.renderDistance, this.mc.gameSettings.chatVisibility,
      this.mc.gameSettings.chatColours, this.mc.gameSettings.difficulty));
  ...
  public void handlePickupSpawn(Packet21PickupSpawn par1Packet21PickupSpawn)
  {
    ...
    EntityItem var8 = new EntityItem(this.worldClient, var2, var4, var6,
      new ItemStack(par1Packet21PickupSpawn.itemID,
        par1Packet21PickupSpawn.count, par1Packet21PickupSpawn.itemDamage));
  ...
  public void handleVehicleSpawn(Packet23VehicleSpawn par1Packet23VehicleSpawn)
  {
    ...
    if (var8 != null)
    {
      ...
      this.worldClient.addEntityToWorld(par1Packet23VehicleSpawn.entityId,
        (Entity) var8);
  ...
  public void handleEntityExpOrb(Packet26EntityExpOrb par1Packet26EntityExpOrb)
  {
    EntityXPOrb var2 = new EntityXPOrb(this.worldClient,
      ...
      (double) par1Packet26EntityExpOrb.posZ, par1Packet26EntityExpOrb.xpValue);
  ...
  public void handleEntityPainting(Packet25EntityPainting par1Packet25EntityPainting)
  {
    EntityPainting var2 = new EntityPainting(this.worldClient,
      ...
      par1Packet25EntityPainting.direction, par1Packet25EntityPainting.title);
  ...
  public void handleEntityVelocity(Packet28EntityVelocity par1Packet28EntityVelocity)
  {
    ...
    if (var2 != null)
    {
      var2.setVelocity((double) par1Packet28EntityVelocity.motionX / 8000.0D,
  ...
  public void handleNamedEntitySpawn(Packet20NamedEntitySpawn par1Packet20NamedEntitySpawn)
  {
    ...
    this.worldClient.addEntityToWorld(par1Packet20NamedEntitySpawn.entityId,
      var10);
  ...
  public void handleMultiBlockChange(Packet52MultiBlockChange par1Packet52MultiBlockChange)
  {
    ...
    {
      DataInputStream var4 = new DataInputStream(new ByteArrayInputStream(
      ...
      try
      {
        for (int var5 = 0; var5 < par1Packet52MultiBlockChange.size; ++var5)
        {
          ...
          int var11 = var6 >> 8 & 15;
          int var12 = var6 & 255;
          this.worldClient.setBlockAndMetadataAndInvalidate(var10 + var2,
            var12, var11 + var3, var8, var9);
        }
      }
  ...
  public void handleMapChunk(Packet51MapChunk par1Packet51MapChunk)
  {
    ...
    this.worldClient.invalidateBlockReceiveRegion(
      par1Packet51MapChunk.xCh << 4, 0, par1Packet51MapChunk.zCh << 4,
    ...
    if (par1Packet51MapChunk.includeInitialize && var2 == null)
    {
      this.worldClient.doPreChunk(par1Packet51MapChunk.xCh,
        par1Packet51MapChunk.zCh, true);
      var2 = this.worldClient.getChunkFromChunkCoords(par1Packet51MapChunk.xCh,
        par1Packet51MapChunk.zCh);
    }

    if (var2 != null)
    {
      var2.fillChunk(par1Packet51MapChunk.func_73593_d(),
        par1Packet51MapChunk.yChMin, par1Packet51MapChunk.yChMax,
        par1Packet51MapChunk.includeInitialize);
      this.worldClient.markBlocksDirty(par1Packet51MapChunk.xCh << 4, 0,
        par1Packet51MapChunk.zCh << 4, (par1Packet51MapChunk.xCh << 4) + 15,
        256, (par1Packet51MapChunk.zCh << 4) + 15);
  ...
  public void handleBlockChange(Packet53BlockChange par1Packet53BlockChange)
  {
    this.worldClient.setBlockAndMetadataAndInvalidate(
      par1Packet53BlockChange.xPosition, par1Packet53BlockChange.yPosition,
      par1Packet53BlockChange.zPosition, par1Packet53BlockChange.type,
  ...
  public void handleKickDisconnect(Packet255KickDisconnect par1Packet255KickDisconnect)
  {
    ...
    this.mc.displayGuiScreen(new GuiDisconnected("disconnect.disconnected",
  ...
  public void handleErrorMessage(String par1Str, Object[] par2ArrayOfObj)
  {
    if (!this.field_72554_f)
    {
      ...
      ModLoader.clientDisconnect();
      this.mc.loadWorld((WorldClient) null);
      this.mc.displayGuiScreen(new GuiDisconnected("disconnect.lost", par1Str,
        par2ArrayOfObj));
    }
  }
  ...
  public void handleCollect(Packet22Collect par1Packet22Collect)
  {
    ...
    if (var2 != null)
    {
      ...
      {
        this.worldClient.playSoundAtEntity(
          var2,
          "random.orb",
          0.2F,
      ...
      this.mc.effectRenderer.addEffect(new EntityPickupFX(this.mc.theWorld,
        var2, (Entity) var3, -0.5F));
  ...
  public void handleChat(Packet3Chat par1Packet3Chat)
  {
    ...
    ChatProcessor.getInstance().addChatToQueue(par1Packet3Chat.message);
  ...
  public void handleAnimation(Packet18Animation par1Packet18Animation)
  {
    ...
    if (var2 != null)
    {
      ...
      else if (par1Packet18Animation.animate != 4)
      {
        ...
        {
          this.mc.effectRenderer.addEffect(new EntityCrit2FX(this.mc.theWorld,
            var2));
        }
        else if (par1Packet18Animation.animate == 7)
        {
          EntityCrit2FX var4 = new EntityCrit2FX(this.mc.theWorld, var2,
            "magicCrit");
  ...
  public void handleSleep(Packet17Sleep par1Packet17Sleep)
  {
    ...
    if (var2 != null && par1Packet17Sleep.field_73622_e == 0)
    {
      ...
      var3.sleepInBedAt(par1Packet17Sleep.bedX, par1Packet17Sleep.bedY,
        par1Packet17Sleep.bedZ);
    }
  }
  ...
  public void handleSpawnPosition(Packet6SpawnPosition par1Packet6SpawnPosition)
  {
    this.mc.thePlayer.setSpawnChunk(new ChunkCoordinates(
      par1Packet6SpawnPosition.xPosition, par1Packet6SpawnPosition.yPosition,
  ...
  /**
   * Recieves player health from the server and then proceeds to set it locally
   * on the client.
   */
  ...
  public void handleRespawn(Packet9Respawn par1Packet9Respawn)
  {
    if (par1Packet9Respawn.respawnDimension != this.mc.thePlayer.dimension)
    {
      ...
      this.worldClient = new WorldClient(this, new WorldSettings(0L,
        par1Packet9Respawn.gameType, false,
        this.mc.theWorld.getWorldInfo().isHardcoreModeEnabled(),
        par1Packet9Respawn.terrainType), par1Packet9Respawn.respawnDimension,
  ...
  public void handleExplosion(Packet60Explosion par1Packet60Explosion)
  {
    Explosion var2 = new Explosion(this.mc.theWorld, (Entity) null,
      par1Packet60Explosion.explosionX, par1Packet60Explosion.explosionY,
      par1Packet60Explosion.explosionZ, par1Packet60Explosion.explosionSize);
  ...
  public void handleSetSlot(Packet103SetSlot par1Packet103SetSlot)
  {
    ...
    else
    {
      ...
      {
        ItemStack var5 = var2.inventorySlots.getSlot(
        ...
        var2.inventorySlots.putStackInSlot(par1Packet103SetSlot.itemSlot,
      ...
      {
        var2.craftingInventory.putStackInSlot(par1Packet103SetSlot.itemSlot,
          par1Packet103SetSlot.myItemStack);
      }
    }
  }
  ...
  public void handleUpdateSign(Packet130UpdateSign par1Packet130UpdateSign)
  {
      ...
      par1Packet130UpdateSign.yPosition, par1Packet130UpdateSign.zPosition))
    {
      TileEntity var2 = this.mc.theWorld.getBlockTileEntity(
        par1Packet130UpdateSign.xPosition, par1Packet130UpdateSign.yPosition,
  ...
  public void handleTileEntityData(Packet132TileEntityData par1Packet132TileEntityData)
  {
      ...
      par1Packet132TileEntityData.zPosition))
    {
      ...
      if (var2 != null && par1Packet132TileEntityData.actionType == 1
  ...
  public void handleUpdateProgressbar(Packet105UpdateProgressbar par1Packet105UpdateProgressbar)
  {
    ...
    if (var2.craftingInventory != null
        && var2.craftingInventory.windowId == par1Packet105UpdateProgressbar.windowId)
    {
      var2.craftingInventory.updateProgressBar(
  ...
  public void handlePlayerInventory(Packet5PlayerInventory par1Packet5PlayerInventory)
  {
    ...
    if (var2 != null)
    {
      var2.func_70062_b(par1Packet5PlayerInventory.slot,
        par1Packet5PlayerInventory.func_73397_d());
    }
  }
  ...
  public void handleBlockEvent(Packet54PlayNoteBlock par1Packet54PlayNoteBlock)
  {
    this.mc.theWorld.addBlockEvent(par1Packet54PlayNoteBlock.xLocation,
      par1Packet54PlayNoteBlock.yLocation, par1Packet54PlayNoteBlock.zLocation,
      par1Packet54PlayNoteBlock.blockId,
      par1Packet54PlayNoteBlock.instrumentType, par1Packet54PlayNoteBlock.pitch);
  }
  ...
  public void handleBlockDestroy(Packet55BlockDestroy par1Packet55BlockDestroy)
  {
    this.mc.theWorld.destroyBlockInWorldPartially(
      par1Packet55BlockDestroy.func_73322_d(),
      par1Packet55BlockDestroy.func_73321_f(),
      par1Packet55BlockDestroy.func_73324_g(),
      par1Packet55BlockDestroy.func_73320_h(),
      par1Packet55BlockDestroy.func_73323_i());
  }
  ...
  public void handleMapChunks(Packet56MapChunks par1Packet56MapChunks)
  {
    for (int var2 = 0; var2 < par1Packet56MapChunks.func_73581_d(); ++var2)
    {
      ...
      this.worldClient.invalidateBlockReceiveRegion(var3 << 4, 0, var4 << 4,
        (var3 << 4) + 15, 256, (var4 << 4) + 15);
      ...
      if (var5 != null)
      {
        var5.fillChunk(par1Packet56MapChunks.func_73583_c(var2),
          par1Packet56MapChunks.field_73590_a[var2],
          par1Packet56MapChunks.field_73588_b[var2], true);
        this.worldClient.markBlocksDirty(var3 << 4, 0, var4 << 4,
          (var3 << 4) + 15, 256, (var4 << 4) + 15);
  ...
  public void handleBed(Packet70GameEvent par1Packet70GameEvent)
  {
    ...
    if (var3 >= 0 && var3 < Packet70GameEvent.bedChat.length
        && Packet70GameEvent.bedChat[var3] != null)
    {
    ...
    else if (var3 == 5)
    {
      ...
      {
        this.mc.ingameGUI.getChatGUI().func_73757_a(
          "demo.help.movement",
          new Object[]{Keyboard.getKeyName(var5.keyBindForward.keyCode),
      ...
      {
        this.mc.ingameGUI.getChatGUI().func_73757_a("demo.help.jump",
          new Object[]{Keyboard.getKeyName(var5.keyBindJump.keyCode)});
      }
      else if (var4 == 103)
      {
        this.mc.ingameGUI.getChatGUI().func_73757_a("demo.help.inventory",
          new Object[]{Keyboard.getKeyName(var5.keyBindInventory.keyCode)});
      }
    }
  }
  ...
  public void handleMapData(Packet131MapData par1Packet131MapData)
  {
    ...
    {
      ItemMap.getMPMapData(par1Packet131MapData.uniqueID, this.mc.theWorld).updateMPMapData(
  ...
  {
    this.mc.theWorld.playAuxSFX(par1Packet61DoorChange.sfxID,
  ...
  public void handleEntityEffect(Packet41EntityEffect par1Packet41EntityEffect)
  {
    ...
    {
      ((EntityLiving) var2).addPotionEffect(new PotionEffect(
        par1Packet41EntityEffect.effectId, par1Packet41EntityEffect.duration,
  ...
  {
    this.mc.theWorld.playSound(par1Packet62LevelSound.func_73572_f(),
      par1Packet62LevelSound.func_73568_g(),
      par1Packet62LevelSound.func_73569_h(),
      par1Packet62LevelSound.func_73570_d(),
      par1Packet62LevelSound.func_73571_i(),
      par1Packet62LevelSound.func_73573_j());
  }
  ...
  public void handleCustomPayload(Packet250CustomPayload par1Packet250CustomPayload)
  {
    if ("MC|TPack".equals(par1Packet250CustomPayload.channel))
    {
      ...
      if (var2[1].equals("16"))
      {
        ...
        {
          this.mc.displayGuiScreen(new GuiYesNo(new NetClientWebTextures(this,
            var3), StringTranslate.getInstance().translateKey(
    ...
    {
      DataInputStream var8 = new DataInputStream(new ByteArrayInputStream(
      ...
      try
      {
        ...
        if (var4 != null && var4 instanceof GuiMerchant
            && var9 == this.mc.thePlayer.craftingInventory.windowId)
        {

...
public class GuiChat extends GuiScreen
{
  ...
  public void initGui()
  {
    ...
    this.inputField = new GuiTextField(this.fontRenderer, 4, this.height - 12,
      this.width - 4, 12);
  ...
  protected void mouseClicked(int par1, int par2, int par3)
  {
    ...
    {
      ChatClickData var4 = this.mc.ingameGUI.getChatGUI().func_73766_a(
      ...
      if (var4 != null)
      {
        ...
        if (var5 != null)
        {
          if (this.mc.gameSettings.chatLinksPrompt)
          {
            ...
            this.mc.displayGuiScreen(new GuiChatConfirmLink(this, this,
              var4.func_78309_f(), 0, var4));
          }
          else
          {
  ...
  private void func_73896_a(URI par1URI)
  {
    try
    {
      ...
      Object var3 = var2.getMethod("getDesktop", new Class[0]).invoke(
  ...
  public void completePlayerName()
  {
    ...
    else
    {
      ...
      this.inputField.deleteFromCursor(var1
                                       - this.inputField.getCursorPosition());
    }
  ...
  private void func_73893_a(String par1Str, String par2Str)
  {
    if (par1Str.length() >= 1)
    {
      this.mc.thePlayer.sendQueue.addToSendQueue(new Packet203AutoComplete(
        par1Str));
   ...
   * the previous message, 1 is the next message from the current cursor
   * position
   */
  public void getSentHistory(int par1)
  {
    ...
    if (var2 != this.sentHistoryCursor)
    {
      ...
      else
      {
        ...
        this.inputField.setText((String) this.mc.ingameGUI.getChatGUI().func_73756_b().get(
          var2));
